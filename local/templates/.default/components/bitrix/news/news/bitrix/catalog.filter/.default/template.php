...
<div class="n-filters">
    <form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get"><!--
        ...
        <?foreach($arResult["ITEMS"] as $arItem):?>
            ...
            <?else:?>
                <?if($i++ > 0):?>
                    --><div class="n-filters__break n-filters__break_mobile"></div><!--
                <?endif;?>
                --><div class="n-filters__section">
        ...
        --><div class="n-filters__section">
            <span class="n-filters__name">Дата от:</span>
            <div class="n-filters__input-holder">
                <input type="text" class="n-filters__input calendar-simple">
            </div><!--
                    --><span class="n-filters__delim">до</span><!--
                    --><div class="n-filters__input-holder">
                <input type="text" class="n-filters__input calendar-simple">
            </div>
        </div><!--
        --><div class="n-filters__break"></div><!--
        --><div class="n-filters__section n-filters__section_full clearfix">
            <span class="n-filters__name n-filters__name_float">Теги:</span>
            <div class="n-filters__tags">
                <input class="n-filters__tags-input" id="news-tags" value="новость">
            </div>
        </div>
    </form>
</div>
